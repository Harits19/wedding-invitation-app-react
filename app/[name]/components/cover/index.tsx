  ...
  const Body = () => {
    return (
      <div className="flex flex-col items-center">
        <Div family="averia" className="text-xl text-wed303333">
          {kText.theWedding}
        </Div>
        <div className="h-6" />
        <Image
          className="rounded-full w-[216px] h-[216px] bg-wed303333"
        ...
        />
        <br />
        <Div className="text-3xl text-wed303333" family="berkshire">
          {data?.initial}
        </Div>
        <br />
        ...
        <button
          ...
          className="bg-wedDriftwood py-2 px-12 rounded-sm"
        >
