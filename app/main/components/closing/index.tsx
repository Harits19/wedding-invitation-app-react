  ...
  return (
    <Scaffold className="">
      ...
      <div className="items-center flex flex-col -m-5 text-center p-14">
        ...
        <Image
          alt="closing photo"
          className="border-driftwood border-4 rounded-md w-[219px] h-[219px] border-"
          src={kPublic.photoGallery1}
        />
        <div className="h-5" />
        <div className="text-sm ">{kText.merupakanSuatuKebahagiaan}</div>
        <div className="h-10" />
        <div className="text-sm ">{kText.terimaKasih}</div>
      </div>
